...
public class InternSettings : BaseEntity<int>
{
    ...
    public DateTime JobDealine { get; set; } //1 week: get ins, rec, WAITING+APPLIED => "1 week left", today: get ins, rec, WAITING+APPLIED => "today is the deadline", 1d past: get WAITING+APPLIED => REJECTED + "You are not qualified for this internship"
