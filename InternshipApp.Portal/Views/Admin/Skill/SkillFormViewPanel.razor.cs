...
public partial class SkillFormViewPanel
{
    ...
    public override async Task SetParametersAsync(ParameterView parameters)
    {
        ...
        var newActionRequest = default(FormRequest<FormAction, Skill>);
    ...
    private async void OnFormResultReceived(FormResult<Skill> result)
    {
        await this.OnDismissedAsync(result);
    }

    private async Task OnDismissedAsync(FormResult<Skill> result = null)
    {
