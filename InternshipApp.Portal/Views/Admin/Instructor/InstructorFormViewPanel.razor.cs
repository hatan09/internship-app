...
public partial class InstructorFormViewPanel
{
    ...
    public override async Task SetParametersAsync(ParameterView parameters)
    {
        ...
        var newActionRequest = default(FormRequest<FormAction, Instructor>);
    ...
    private async void OnFormResultReceived(FormResult<Instructor> result)
    {
        await this.OnDismissedAsync(result);
    }

    private async Task OnDismissedAsync(FormResult<Instructor> result = null)
    {
