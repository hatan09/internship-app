...
public partial class StudentInfoFormPanel
{
    ...
    public override async Task SetParametersAsync(ParameterView parameters)
    {
        ...
        var newActionRequest = default(FormRequest<FormAction, Student>);
    ...
    private async void OnFormResultReceived(FormResult<Student> result)
    {
        await this.OnDismissedAsync(result);
    }

    private async Task OnDismissedAsync(FormResult<Student> result = null)
    {
